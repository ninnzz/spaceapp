...
FACCOUNTS_PARAMS = {
    ...
    'redirect_uri': 'http://api.staging.tunes.tm/auth/callback',
    'response_type': 'code',
...
EMAIL = {
    ...
    'footer': '''
                <br/><br/>
                You may now log in to <a href="http://staging.tunes.tm">Tunes.tm</a>
                by clicking on the link below or copying and pasting it in your browser:
                <br/><br/>
                <a href="http://staging.tunes.tm/login">http://staging.tunes.tm/#/login</a>
                <br/><br/>
                <img src="http://staging.tunes.tm/images/email-banner.png"/>
            '''
}

# Frontend URL
FRONTEND_URL = 'http://staging.tunes.tm'
